package com.example.qoyumalkahfi.qoyum_1202154125_modul6.adapter;
...
import com.example.qoyumalkahfi.qoyum_1202154125_modul6.DetailPost;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    Context context;
    List<com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Post> postList;

    public PostAdapter(Context context, List<com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Post> postList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Post post= postList.get(position);
        ...
        holder.cardViewPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("PostAdapter",post.getPost());
