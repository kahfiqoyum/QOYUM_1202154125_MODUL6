...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    Context context;
    List<com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Comment> commentList;
//    RoundedBitmapDrawable rounded;

    public CommentAdapter(Context context, List<com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Comment> commentList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Comment comment= commentList.get(position);
