...
import com.example.qoyumalkahfi.qoyum_1202154125_modul6.model.Post;
...
public class AddPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseFood = FirebaseDatabase.getInstance().getReference(Main.table1);
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (imageUri != null && !TextUtils.isEmpty(name)) {
                    ...
                    Intent i = new Intent(AddPost.this, Main.class);
                    startActivity(i);
                } else {
